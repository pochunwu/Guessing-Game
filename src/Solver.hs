module Solver (feedbackWord, scoreWord, normalizeFrequencies, calculateLetterFrequencies, filterWordsImpossible, filterWordsCorrectPlace, calculateEntropyForWords, writeEntropyMapToFile, generateNextGuessList, readFileAsWordScores) where
